...
class PlayState extends MusicBeatState
{
	...
	public var slyUnlocked:Bool = false;
	public var rogerUnlocked:Bool = false;
	public var resonanceUnlocked:Bool = false;
	public var nightRogerUnlocked:Bool = false;
			...
			if (isStoryMode)
			{
				...
				if (storyPlaylist.length <= 0)
				{
					...
					if(!usedPractice) {
						...
						if (SONG.song.toLowerCase() == "sly" && !slyUnlocked)
							{
								slyUnlocked = true;
								FlxG.save.data.slyUnlocked = slyUnlocked;
							}
						if (SONG.song.toLowerCase() == "roger" && !rogerUnlocked)
							{
								rogerUnlocked = true;
								FlxG.save.data.rogerUnlocked = rogerUnlocked;
							}
						if (SONG.song.toLowerCase() == "quake" && !resonanceUnlocked)
							{
								resonanceUnlocked = true;
								FlxG.save.data.resonanceUnlocked = resonanceUnlocked;
							}
						if (SONG.song.toLowerCase() == "nightmare" && !nightRogerUnlocked)
						{
							nightRogerUnlocked = true;
							FlxG.save.data.nightRogerUnlocked = nightRogerUnlocked;
						}
